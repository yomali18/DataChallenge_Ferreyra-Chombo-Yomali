...
3.  **Análisis espacial**
    ...
    En esta sección se importaron las coordenadas para cada distrito, así como también información de la superficie para poder representar los cambios de la incidencia y temperatura en relación a cada distrito, año y SE. Posteriormente, se realizó un mapa interactivo para visualizar tal información (se demora un poco en cargar)
